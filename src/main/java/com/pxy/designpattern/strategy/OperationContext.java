...
public class OperationContext {
    ...
    private static Operation createOperation(String operator) throws Exception {
    ...
    private static Operation newOperationInstance(String operator) throws Exception {
        switch (operator) {
            case "+":
